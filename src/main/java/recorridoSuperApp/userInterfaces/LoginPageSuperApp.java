...
public class LoginPageSuperApp extends PageObject {
    ...
    public static final Target  BTN_ACEPTAR_AUTORIZACION_MEDICION_DE_VELOCIDAD = Target.the(" ACEPTAR AUTORIZACION MEDICION DE VELOCIDAD").locatedBy("(//*[contains(@text,'Aceptar')])[2]");
    ...
    public static final Target LBL_ENCABEZADO_USUARIO =
            Target.the("Modal Acepta Terminos y Condiciones").located(MobileBy.id("textViewGreeting"));
