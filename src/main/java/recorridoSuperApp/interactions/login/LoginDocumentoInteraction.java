...
import static recorridoSuperApp.userInterfaces.segmento.SegmentoPage.BTN_USUARIO;
...
public class LoginDocumentoInteraction implements Interaction {

    User credenciales;

    public LoginDocumentoInteraction(User credenciales) {
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitElement.isEnable(TXT_DOCUMENTO),
                Enter.theValue(credenciales.getEmail()).into(TXT_DOCUMENTO),
    ...
    public static Performable whitData(User credenciales) {
        return instrumented(LoginDocumentoInteraction.class, credenciales);
    }
